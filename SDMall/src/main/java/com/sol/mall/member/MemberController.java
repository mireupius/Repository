...
public class MemberController {
	...
	// public String doRegSeller(Seller s, HttpServletRequest req,
	...
	// public String regP(Product p, HttpServletRequest req, HttpServletResponse
	// res) {
	...
	// public String loginMember(Customer c, Seller s, HttpServletRequest req,
	// HttpServletResponse res) {
