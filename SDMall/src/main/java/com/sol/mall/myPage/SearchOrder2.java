...
public class SearchOrder2 {
	...
	public SearchOrder2(String sd_customer_id, BigDecimal sb_searchMonth, Date sd_order_date, String sd_claim,
			String sd_delivery_state, String sd_delivery_pno, String sd_product_no, String sd_product_name,
			String sd_option_type, String sd_option_info, BigDecimal sd_amount, BigDecimal sd_option_price,
			BigDecimal sd_product_price, BigDecimal sd_product_sellprice, BigDecimal sd_total_price, Date sd_check_date,
			String gd_no, String gd_imgl, String gd_imgm, String gd_imgs, String gd_imgss) {
		super();
