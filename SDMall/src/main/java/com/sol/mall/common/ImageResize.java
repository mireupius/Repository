...
public class ImageResize {
	 ...
	 public static void resize(int newWidth, int newHeight, String imgOriginalPath, String imgTargetPath, String imgFormat) {
//	        int newWidth = 600;                                 // 변경 할 폭(너비)
...
//	        String imgFormat = "jpg";                           // 새 이미지 포맷. jpg, gif 등
		 	...
		 	String mainPosition = "W";                          // W:폭중심, H:높이중심, X:설정한 수치로(비율무시)
