					...
					<div class="row">
						...
						<div class="col-lg-3 col-sm-3 col-3 order-1">
							<div class="logo_container">
								<div class="logo">
									<a href="/mall"><img alt="SD Mall"
										src="resources/etc/logo.png"></a>
								</div>
							</div>
						</div>
									...
									<div class="header_search_form_container">
										<form action="shop.search" class="header_search_form clearfix">
											...
											<button type="submit" class="header_search_button trans_300"
												value="Submit">
												<img src="resources/etc/search.png" alt="">
											</button>
						...
						<!-- Wishlist -->
						<div
							class="col-lg-3 col-9 order-lg-3 order-2 text-lg-left text-right">
							<div
								...
								<div
									...
									<div class="wishlist_content">
										<div class="wishlist_icon">
											<a href="member.loginPage"><img
												src="resources/etc/icon-login.png" alt=""></a>
										</div>
								...
								<div
									...
									<div class="wishlist_content">
										<div class="wishlist_icon">
											<a href="customer.myHome.go"><img
												src="resources/etc/icon-myhome.png" alt=""></a>
										</div>
										<div class="wishlist_text">
									...
									<ul class="cat_menu">
										<c:forEach var="cate1" items="${allCategory}">
											<c:if test="${cate1.ct_clf==1 }">
												<li class="hassubs"><a
													href="shop.Category?ct_no=${cate1.ct_no }">${cate1.ct_clfname }<i
														class="fas fa-chevron-right"></i></a>
													<ul>
														<c:forEach var="cate2" items="${allCategory}">
															<c:if test="${cate2.ct_parentno==cate1.ct_no }">
																<li class="hassubs"><a
																	href="shop.Category?ct_no=${cate2.ct_no }">${cate2.ct_clfname }<i
																		class="fas fa-chevron-right"></i></a>
																	<ul>
																		<c:forEach var="cate3" items="${allCategory}">
																			<c:if test="${cate3.ct_parentno==cate2.ct_no }">
																				<li><a
																					href="shop.Category?ct_no=${cate3.ct_no }">${cate3.ct_clfname }<i
