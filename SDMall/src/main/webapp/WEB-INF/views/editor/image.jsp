...
<link rel=stylesheet type=text/css
	href="${pageContext.request.contextPath}/resources/daumeditor/css/popup.css"
	charset=utf-8 />
<script type=text/javascript charset=utf-8
	src="${pageContext.request.contextPath}/resources/daumeditor/js/popup.js"></script>
	...
	$(document).ready(
		...
		$('.file input[type=file]').change(
				function() {
					...
					inputObj.val(fileLocation.replace(
							'C:\\fakepath\\', '')); // 몇몇 브라우저는 보안을 이유로 경로가 변경되서 나오므로 대체 후 text에 경로 넣기 
		});
		...
		$('.submit a').on('click', function() {
			...
			form.ajaxSubmit({
				type : 'POST',
				url : '${pageContext.request.contextPath}/daumeditor/singleUploadImageAjax',
				...
				success : function(
					fileInfo) { // fileInfo는 이미지 정보를 리턴하는 객체 
...
<body onload="initUploader();">
	...
	<div class="wrapper">
		...
		<div class="body">
			<dl class=alert>
				<dt>&nbsp; 5MB이하 (JPG,GIF,PNG,BMP)</dt>
				<dd>
					<form id=daumeditorForm encType=multipart/form-data method=post
						action="">
						<!-- 파일첨부 -->
						<div class=file>
