...
<!-- 다음오픈에디터 라이브러리 --> 
<link rel=stylesheet type=text/css href="${pageContext.request.contextPath}/resources/daumeditor/css/popup.css" charset=utf-8 /> 
<script type=text/javascript charset=utf-8 src="${pageContext.request.contextPath}/resources/daumeditor/js/popup.js"></script> 
<!-- jQuery 라이브러리 --> 
<script src="${pageContext.request.contextPath}/resources/js/jquery.js"></script>

<!-- jquery.form.js - ajaxSubmit() 사용 --> 
<script src="${pageContext.request.contextPath}/resources/daumeditor/js/jquery.form.js"></script>
